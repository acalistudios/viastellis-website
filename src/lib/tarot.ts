...
export const REVERSED_MEANINGS: Record<number, string> = {
  // Major Arcana
  0:  'Held back by fear and second-guessing; a leap you need to take stalls at the edge.',
  ...
  18: 'Confusion and fear begin to clear; hidden truths surface and illusions dissolve.',
  ...
  42: 'Clarity cuts through the haze of options; you focus and commit to what is real.',
  43: 'Caught between staying and leaving, you linger instead of moving on.',
  ...
  51: 'The stalemate finally breaks; a truth you avoided surfaces and the choice can wait no longer.',
  52: 'The worst of the heartbreak passes; you begin to release the pain and heal.',
  ...
  56: 'Hidden motives come to light; it is time to come clean and act with integrity.',
  57: 'You begin to free yourself; the mental cage was never truly locked.',
  58: 'Anxiety loosens its grip; naming the fear in daylight robs it of its power.',
  ...
  68: 'The hard times begin to lift; support is closer than it seemed — look up.',
